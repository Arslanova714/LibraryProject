...
# Список ISBN для добавления
BOOKS_TO_ADD = [
    "9785389047938",  # Война и мир
    "9785171184630",  # Преступление и наказание
    "9780451524935",  # 1984
    "9785496020084",  # Чистый код
    "9785961434628",  # Совершенный код
    "9785170643972",  # Мастер и Маргарита
    "9785389202658",  # 451 градус по Фаренгейту
    "9785446102800",  # Операционные системы (Таненбаум)
    "9785496021852",  # Идеальный программист
    "9785171033259",  # Властелин колец: Братство Кольца
    "9785171033266",  # Властелин колец: Две крепости
    "9785171033273",  # Властелин колец: Возвращение короля
    "9785699406346",  # Двенадцать стульев
    "9785171023908",  # Гарри Поттер и Философский камень
    "9785171023915",  # Гарри Поттер и Тайная комната
]
